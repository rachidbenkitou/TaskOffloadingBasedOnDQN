 ...
 *     @author Mechalikh
 **/
package examples.taskoffloadingExamples;

import com.mechalikh.pureedgesim.MainApplication;
import com.mechalikh.pureedgesim.TasksOrchestration.DQNOrchestrator;
import com.usms.offloading.offdqn.orchestrator.OffDqnOrchestrator;
import examples.FuzzyLogicOrchestrator;
...
public class Example8 extends MainApplication {
	...
	private static String settingsPath = "PureEdgeSim/examples/taskoffloadingExamples/";

	// The custom output folder is
	private static String outputPath = "PureEdgeSim/examples/taskoffloadingExamples/output/";
